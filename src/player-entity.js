...
export const player_entity = (() => {
  ...
  class BasicCharacterController extends entity.Component {
    ...
    _LoadModels() {
      ...
      loader.load('Neutral Idle.fbx', (fbx) => {
        this._target = fbx;
        // Scale size of main character
        this._target.scale.setScalar(0.055);
        
        //const input2 = this.GetComponent('BasicCharacterControllerInput');
        //this._stateMachine.Update(timeInSeconds, input2);
        //if (input2._keys.shift) {
         // this._target.position.y = 500;
        //}
        //this._target.position.y = start;
        

        //this._target.position.y = -300
        ...
        loader.setPath('./resources/MainPlayer/');
    ...
    Update(timeInSeconds) {
      ...
      //pos.y=0;
      // To make player go below into a new 'world' which is ETB.
      // if (input._keys.downarrow) {
      //   pos.y=-250;
      // }
      // if (input._keys.uparrow && pos.y==-250) {
      //   pos.y=0;
      // }
